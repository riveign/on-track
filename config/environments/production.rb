...
Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "on_track_production"
  ...
  routes.default_url_options = { host: 'on-track.cloud', protocol: 'https' }
  ...
  config.hosts << ['on-track.cloud', 'www.on-track.cloud']
end
